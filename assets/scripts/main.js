(function () {
  ...
  var default_1 = /** @class */ (function () {
      function default_1(el) {
          ...
          this.titleAnime = anime({
              targets: this.$titleLetters,
              duration: 700,
              delay: anime.stagger(30, { start: 200 }),
              easing: 'cubicBezier(0.8, 0, 0.2, 1)',
              translateY: function () { return _this.isHidden ? [0, _this.dir > 0 ? '-100%' : '100%'] : [_this.dir > 0 ? '100%' : '-100%', 0]; },
              opacity: function () { return ({
                  value: _this.isHidden ? 0 : 1,
                  duration: 1,
                  delay: _this.isHidden ? 900 : 200,
              }); },
              autoplay: false,
          });
      }
      default_1.prototype.show = function (n) {
          var _this = this;
          this.isHidden = false;
          return this.toggle(n).then(function () {
              _this.$el.classList.add('current');
          });
      };
      default_1.prototype.hide = function (n) {
          var _this = this;
          this.isHidden = true;
          return this.toggle(n).then(function () {
              _this.$el.classList.remove('current');
          });
      };
      default_1.prototype.toggle = function (n) {
          return Promise.all([this.toggleTitle(n), this.toggleCover(n)]);
      };
      default_1.prototype.toggleTitle = function (n) {
          ...
          //   }),
          // }).finished
          this.titleAnime.play().finished;
      };
      default_1.prototype.toggleCover = function (n) {
  ...
  var default_1$1 = /** @class */ (function () {
      function default_1$$1(el) {
          this.isAnimating = false;
          this.currentPos = 0;
          this.$el = el;
          this.$pagination = el.querySelector('.index .inner');
          this.entries = Array.from(el.querySelectorAll('.skill'), function (e) { return new default_1(e); });
          el.querySelector('.index .total').innerHTML = "0" + this.entries.length;
          this.currentEntry = this.entries[this.currentPos];
          this.setupEvents();
      }
      default_1$$1.prototype.setupEvents = function () {
          var _this = this;
          this.$el.querySelector('.nav .next').addEventListener('click', function () {
              _this.navigate(1);
          });
          this.$el.querySelector('.nav .prev').addEventListener('click', function () {
              _this.navigate(-1);
          });
      };
      default_1$$1.prototype.navigate = function (n) {
          var _this = this;
          if (this.isAnimating)
              return;
          ...
          var entry = this.entries[this.currentPos];
          Promise.all([
      ...
      default_1$$1.prototype.updatePagination = function (n) {
          var _this = this;
          ...
          return anime({
              ...
              update: function (anime$$1) {
                  if (anime$$1.progress >= 50 && !halfway) {
                      halfway = true;
                      _this.$pagination.innerHTML = "0" + (_this.currentPos + 1);
                  }
              },
          }).finished;
      };
  ...
  window.onload = function () {
      new default_1$1(document.querySelector('.hero > .skills'));
      var rellax$$1 = new rellax('[data-rellax-speed]', {
          speed: -2,
          center: false,
          wrapper: null,
          round: true,
      ...
      document.querySelectorAll('[data-parallax]').forEach(function ($el) {
          ...
          var properties = JSON.parse($el.dataset.parallax);
